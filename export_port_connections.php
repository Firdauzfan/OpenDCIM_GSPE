<?php
	...
	if ( $_REQUEST["deviceid"] == "wo" ) {
		header( sprintf( "Content-Disposition: attachment;filename=\"vioDCIM-workorder-%s-connections.xlsx\"", date( "YmdHis" ) ) );	
	} else {
		header( "Content-Disposition: attachment;filename=\"vioDCIM-dev" . $devList[0]->DeviceID . "-connections.xlsx\"" );
	}
